...
interface MessageDao {
    ...
    @Query("UPDATE messages SET senderName = :newName, avatarId = :avatarId WHERE senderAddress = :senderAddress")
    suspend fun updateSenderProfile(senderAddress: String, newName: String, avatarId: Int): Int
